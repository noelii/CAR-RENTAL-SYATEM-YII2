...
use backend\controllers\CarControllerbackup;
use common\models\back;
...
class SiteController extends Controller
{
    ...
    public function actionChangePassword()
    {
        ...
        if($model->load(\Yii::$app->request->post())){
            ...
            if($result==1){
                \Yii::$app->session->setFlash('success', 'successful Update Password');
            }
            else{
    ...
    public function actionRent($id)
    {
        ...
        if($model->load(yii::$app->request->post()))
        {
            ...
            if($result==true)
            {
                ...
                return $this->redirect(['rent', 'id' => $model1->id]);
            }
            else
            {
                \Yii::$app->session->setFlash('error', 'The Car has been Rented');
